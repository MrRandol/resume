export const person = {
  ...
  skills: [
    ...
    { name: "webServer_WildFly", level: "60" },
    { name: "webServer_NodeJs", level: "80" },
    ...
    { name: "framework_ReactJs", level: "85" },
    { name: "framework_Angular", level: "85" },
    ...
    { name: "softSkill_GestionDeProjet", level: "60" },
    { name: "softSkill_SIG", level: "90" }
  ],
  work: [
    {
